...
-- Schema alinedb-mm
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `alinedb-mm` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `alinedb-mm` ;

-- -----------------------------------------------------
-- Table `alinedb-mm`.`bank`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-mm`.`bank` (
...
-- -----------------------------------------------------
-- Table `alinedb-mm`.`branch`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-mm`.`branch` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `address` VARCHAR(255) NOT NULL,
  `city` VARCHAR(255) NOT NULL,
...
-- -----------------------------------------------------
-- Table `alinedb-mm`.`applicant`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-mm`.`applicant` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `address` VARCHAR(255) NOT NULL,
  `city` VARCHAR(255) NOT NULL,
...
-- -----------------------------------------------------
-- Table `alinedb-mm`.`member`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-mm`.`member` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `FK1uj76dnpxoa9i8afaaslycb59`
    ...
    REFERENCES `alinedb-mm`.`branch` (`id`),
  CONSTRAINT `FKmhn91ma4lb6uiy6n1ao6tbwkj`
    FOREIGN KEY (`applicant_id`)
    REFERENCES `alinedb-mm`.`applicant` (`id`))
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `alinedb-mm`.`account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-mm`.`account` (
  ...
  CONSTRAINT `FK8mr193rmld8wwqn5nlbr8vclx`
    ...
    REFERENCES `alinedb-mm`.`member` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `alinedb-mm`.`account_holder`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-mm`.`account_holder` (
  ...
  CONSTRAINT `FKn4212xs4wsfh8cfj9rddju6ic`
    ...
    REFERENCES `alinedb-mm`.`account` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `alinedb-mm`.`account_sequence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-mm`.`account_sequence` (
...
-- -----------------------------------------------------
-- Table `alinedb-mm`.`application`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-mm`.`application` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `alinedb-mm`.`application_applicant`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-mm`.`application_applicant` (
  ...
  CONSTRAINT `FKahrhusgia8sp6xy44fbjhc1po`
    ...
    REFERENCES `alinedb-mm`.`application` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `alinedb-mm`.`merchant`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-mm`.`merchant` (
...
-- -----------------------------------------------------
-- Table `alinedb-mm`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-mm`.`user` (
...
-- -----------------------------------------------------
-- Table `alinedb-mm`.`one_time_passcode`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-mm`.`one_time_passcode` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `alinedb-mm`.`otp_sequence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-mm`.`otp_sequence` (
  `next_val` BIGINT NULL DEFAULT NULL)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `alinedb-mm`.`transaction`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-mm`.`transaction` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `amount` INT NOT NULL,
  ...
  CONSTRAINT `FKsc1ms700fjxqyq0j4555uc28a`
    ...
    REFERENCES `alinedb-mm`.`merchant` (`code`))
ENGINE = InnoDB
AUTO_INCREMENT = 3
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `alinedb-mm`.`user_registration_token`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alinedb-mm`.`user_registration_token` (
